    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <div className="flex items-center gap-2">
          {/* Left Annotation */}
          <div className="min-w-[4] text-right border border-dashed border-black/50 min-h-[1.5rem] flex items-center justify-end px-1 rounded-sm shrink-0">
            {isEditingLeft ? (
              <input
                autoFocus
          ...
          {/* Right Annotation */}
          <div className="min-w-[4] text-left border border-dashed border-black/50 min-h-[1.5rem] flex items-center justify-start px-1 rounded-sm shrink-0">
            {isEditingRight ? (
              <input
                autoFocus
